...
public class HomeController extends Controller {
     ...
     */
    public Result index() {
        return ok(index.render("Logueate en el sistema para comenzar a recibir recomendaciones sobre artistas",null,null,null));
    }
    ...
    public Result login(){
        ...
        return ok(index.render("Your new application is ready.",null,null,null));
    }
